...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/make-translation.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/make-translation.js":
/*!*********************************!*\
  !*** ./src/make-translation.js ***!
  \*********************************/
...
module.exports = class MakeTranslation {
  constructor({
    ...
    _defineProperty(this, "createTranslator", language => content => new Promise((resolve, reject) => this.awsTranslate.translateText({
    ...
    _defineProperty(this, "init", async (_ref) => {
      let {
        ...
        english
          ...
          params = _objectWithoutProperties(_ref, ["languages", "english"]);
...
/******/ })));
//# sourceMappingURL=make-translation.js.map